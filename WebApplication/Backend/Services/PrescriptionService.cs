...
namespace WebApplication.Backend.Services
{
    public class PrescriptionService
    {
        ...
        public List<SearchEntityDTO> GetSearchedPrescription(string searchedPersription, string dateTimes)
        {
            ...
            //         _prescriptionRepository.GetPrescriptionsByProperty(Propeerty(search[0].Split(",")[2]),
            ...
            //                 _prescriptionRepository.GetPrescriptionsByProperty(Propeerty(search[i].Split(",")[2]),
            ...
            // catch (Exception e)
            // {
            //     return ConverToDTO(_prescriptionRepository.GetPrescriptionsByProperty(

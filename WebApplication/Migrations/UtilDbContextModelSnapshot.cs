            ...
            modelBuilder.Entity("Model.Accounts.Patient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ParentName = "otac",
                            Password = "sifra",
                            SerialNumber = "23cead68-ae88-403b-b607-d1370815b9e3",
                            Surname = "Tanjic"
                        },
                        new
                        {
                            ...
                            ParentName = "mama",
                            Password = "sifraMica",
                            SerialNumber = "ea901c8a-e143-4513-9252-e0568cf0bf19",
                            Surname = "Milic"
                        });
                });
            ...
            modelBuilder.Entity("Model.Blog.Feedback", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SerialNumber = "2475f43b-7183-452d-8672-c47dbab09935",
                            Approved = true,
                        ...
                        new
                        {
                            SerialNumber = "8ff2648c-4cf8-4672-a0a3-ea2176389904",
                            Approved = false,
                        ...
                        new
                        {
                            SerialNumber = "af7fa810-1d33-41c7-81c0-9d5100b2c219",
                            Approved = true,
                        ...
                        new
                        {
                            SerialNumber = "f08f84d6-dcae-4f57-a126-657790618c36",
                            Approved = false,
                        ...
                        new
                        {
                            SerialNumber = "dc52b0b5-0ee7-4a9f-a648-18bde900ede0",
                            Approved = true,
                        ...
                        new
                        {
                            SerialNumber = "4ec0cb45-5869-4a5d-b0e7-0d45af4a8a90",
                            Approved = false,
                        ...
                        new
                        {
                            SerialNumber = "d7372cf9-caec-4002-aee3-af0319187550",
                            Approved = true,
                        ...
                        new
                        {
                            SerialNumber = "c94cdb1f-4181-4c24-b286-5ca4e8f779a1",
                            Approved = false,
            ...
            modelBuilder.Entity("Model.Util.TimeInterval", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "600001",
                            End = new DateTime(2020, 12, 3, 13, 8, 41, 568, DateTimeKind.Local).AddTicks(8780),
                            Start = new DateTime(2020, 12, 3, 13, 8, 41, 564, DateTimeKind.Local).AddTicks(6428)
                        },
                        new
                        {
                            Id = "600002",
                            End = new DateTime(2020, 12, 3, 13, 8, 41, 569, DateTimeKind.Local).AddTicks(318),
                            Start = new DateTime(2020, 12, 3, 13, 8, 41, 569, DateTimeKind.Local).AddTicks(262)
                        });
                });
            ...
            modelBuilder.Entity("health_clinic_class_diagram.Backend.Model.Survey.Survey", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SerialNumber = "16e85d2f-43bb-4ea6-8d21-2578f05a5008",
                        ...
                        new
                        {
                            SerialNumber = "52f8beaa-fe7e-41aa-b1c1-8c7bc7613b64",

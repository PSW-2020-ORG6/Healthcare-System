...
namespace WebApplicationTests
{
    public class CreateAppointmentTests
    {
        ...
        {
            timeIntervals.Add(new TimeInterval("1234", new DateTime(2020, 12, 11, 08, 00, 00), new DateTime(2020, 12, 11, 08, 20, 00)));
            timeIntervals.Add(new TimeInterval("1235", new DateTime(2020, 12, 11, 08, 20, 00), new DateTime(2020, 12, 11, 08, 40, 00)));
            timeIntervals.Add(new TimeInterval("1235", new DateTime(2020, 12, 11, 08, 40, 00), new DateTime(2020, 12, 11, 09, 00, 00)));

...
namespace WebApplicationTests
{
    public class CreateAppointmentTests
    {
        ...
        public void Find_TimeIntervals()
        {
            ...
            //appointements.Add( new Appointment(new Room("102", 101, new RoomType("Examination room 102")), new Physician("Jana", "Jovic", "600002"), new Patient("5", "Jelena", "Tanjic"), new TimeInterval(new DateTime(2020, 12, 5, 08, 20, 00), new DateTime(2020, 12, 5, 08, 40, 00)), new ProcedureType("Operation on patient 0003", 60, new Specialization("Family doctor")), new DateTime(2020, 12, 20, 08, 20, 00)));

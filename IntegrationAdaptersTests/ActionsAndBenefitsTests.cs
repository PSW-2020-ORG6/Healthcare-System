...
namespace IntegrationAdaptersTests
{
    public class ActionsAndBenefitsTests
    {
        ...
        public void Find_existing_published_message()
        {
            ...
            Guid guid = new Guid("0e65a9a7-2722-45bb-a3de-7832131dcfe3");
        ...
        {
            mock = new Mock<IActionsAndBenefitsRepository>();
            Guid guid = new Guid("0e89a9a7-2722-45bb-a3de-7832131dcfe3");
            Guid guid2 = new Guid("a69b4d8e-55ce-4cdf-bfa6-7462e085a909");

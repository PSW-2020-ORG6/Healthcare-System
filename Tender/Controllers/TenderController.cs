...
namespace TenderProcurement.Controllers
{
    [Route("[controller]")]
    [ApiController]
    public class TenderController : ControllerBase
    {
        ...
        public IActionResult AddTender(TenderProcure  tender)
        {
            tenderService.AddTender(tender);
            return Ok();
        }
        [HttpGet("getAllTenders")]
        public IEnumerable<TenderProcure> GetAllTenders()
        {
        ...
        public TenderProcure GetTender(string name)
        {

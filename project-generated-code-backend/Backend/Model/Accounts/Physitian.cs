...
namespace Model.Accounts
{
    public class Physitian : Account
    {
        ...
        public Physitian(string name, string surname, string id, DateTime dateOfBirth, string contact, string email,
        ...
        [JsonConstructor]
        public Physitian(String serialNumber, string name, string surname, string id, DateTime dateOfBirth,
